...
const PeriodBar: Component<PeriodBarProps> = (props) => {
  ...
  return (
    ...
    >
      ...
      <Select
        ...
        onSelected={(data) => {
          localStorage.setItem(
            "candleType",
            (data as SelectDataSourceItem).key
          );
          const newValue = (data as SelectDataSourceItem).key;
          update(candleOption(), newValue);
        }}
      />
      ...
      <div class="payout">
        <p>Payout:</p>
        <span>{props.symbol.payout || 80}%</span>
      </div>
      {props.lastKnownSymbolPrice && (
        <div class="payout">
          <p>Price:</p>
          <span>{props.lastKnownSymbolPrice}</span>
        </div>
      )}
      {/* <div class="payout">
        <p>Time:</p>
